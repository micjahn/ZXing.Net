...
{
    public sealed class RestrictedAreaTopBlackBoxTestCase : AbstractBlackBoxTestCase
    {
        public RestrictedAreaTopBlackBoxTestCase():base("test/data/blackbox/restricted-area/top", new MultiFormatReader(), null)
        {
            addTest(3, 3, 0, 0, 0.0f, new RestrictedScanningArea(0.03f, 0.1f));
            ...
            addTest(3, 3, 0, 0, 180.0f, new RestrictedScanningArea(0.97f, 0.9f));
        }
    }
}