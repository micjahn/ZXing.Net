...
namespace com.google.zxing.maxicode.decoder
{
   ...
   internal sealed class BitMatrixParser
   {
      ...
      /// <summary>
      /// Prevents a default instance of the <see cref="BitMatrixParser"/> class from being created.
      /// </summary>
      /// <param name="bitMatrix">{@link BitMatrix} to parse</param>
      /// <exception cref="FormatException">if height is not 33 or width is not 30</exception>
