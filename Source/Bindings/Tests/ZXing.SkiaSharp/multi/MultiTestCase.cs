...
namespace ZXing.SkiaSharp.Multi.Test
{
   public class MultiTestCase
   {
      ...
      public void testMulti()
      {
         ...
         var testBase = AbstractBlackBoxTestCase<SKBitmap>.buildTestBase("../../../../../test/data/blackbox/multi-1");

         var source = new SKBitmapLuminanceSource(SKBitmap.Decode(Path.Combine(testBase, "1.png")));
