...
namespace ZXing.Multi.QrCode.Test
{
    ...
    /// </summary>
    public sealed class MultiQRCodeBlackBox1TestCase : SkiaSharp.Test.Common.SkiaBarcodeBlackBoxTestCase
    {
        ...
        public void testMultiQRCodes()
        {
            ...
            var source = new SKBitmapLuminanceSource(SKBitmap.Decode(Path.Combine(path, "1.png")));
